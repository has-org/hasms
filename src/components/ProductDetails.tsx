...
import { Box, Button, Stack, Typography, Container, Accordion, AccordionDetails, AccordionSummary, Divider } from "@mui/material";
  ...
  return (
    <Container maxWidth="lg" >
      <Stack direction="row" spacing={4}>
        ...
        <Stack spacing={2}>
          <Box>
            <Text fontSize="16px" color="#ACACAC">{product.manufacturer}</Text>
            <Text fontSize="20px" fontWeight="bold" className="product-name">
              {product.name}
            </Text>
          </Box>
          <Box>
            <Text className="product-price-value" fontSize="28px" fontWeight="bold" color="#00D0FD">100 KM</Text>
          </Box>
          <Box className="variants-wrap flex items-center gap-x-2">
            <Text className="product-colors-title" color="#ACACAC" fontSize="14px">Izaberi boju: {""}
              {productColors.map((color: ColorType, index: number) => {
                return (
                  <span key={index} className="variant-color" style={{ color: "white", fontWeight: "500" }}>
                    {color.name}
                  </span>
                );
              })}
          ...
          <Stack >
            <Box className="product-price flex gap-x-2 items-center">
              <Text className="product-size-title" color="#ACACAC" fontSize="14px">Veličina:</Text>
          ...
          <Stack direction="row" spacing={2} >
            ...
            <Button variant="contained" disabled style={{ width: '43px', height: '43px', minWidth: '43px', color: 'white' }}>{count}</Button>
            <Button
              variant="text"
              color="secondary"
