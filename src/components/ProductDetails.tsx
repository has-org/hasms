  ...
  return (
    <Box>
      ...
      <Box className="product-code flex gap-x-2">
        <Text className="product-code-key">Šifra:</Text>

        <Text className="product-code-value">{product.code}</Text>
      </Box>
      <Box className="product-brand flex gap-x-2">
        <Text className="product-brand-key">Brend:</Text>

        <Text className="product-brand-value">{product.manufacturer}</Text>
      </Box>
      ...
      <Box className="variants-wrap flex items-center gap-x-2">
        <Text className="product-colors-title">Boja:</Text>
      ...
      <Box className="product-price flex gap-x-2 items-center">
        <Text className="product-size-title">Veličina:</Text>
        <Box component="form" onSubmit={handleSubmit(onSubmitHandler)}>
          ...
          <Button className="" type="submit">
            <Text className="product-description">Dodaj u korpu</Text>
          </Button>
        </Box>
      </Box>
      <Box className="product-price flex gap-x-2">
      ...
      <Text className="product-description-title">Opis:</Text>
    </Box>
  );
};
