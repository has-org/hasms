...
const CooperatorsAnimation = ({ cooperators }: { cooperators: Cooperator[] }) => {
    ...
    useEffect(() => {
        ...
        if (containerElement) {
          ...
          setItemWidth((containerElement.firstChild as HTMLElement)?.offsetWidth || 0);
        }
    }, []);
                ...
                return (
                    ...
                    >
                        ...
                        <Image
                            className="logo-img"
                            alt="Cooperator Logo"
                            src={cooperator?.image ? `${process.env.NEXT_PUBLIC_API_IMG_HOST}${cooperator.image}` : 'https://placehold.co/600x400'}
                            width={500}
                            height={300}
